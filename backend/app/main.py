...
## Как выбирать статус
- ждём пользователя или инициатора → [Ожидание ответа пользователя]
- ждём сопровождение → [Ожидание ответа сопровождения]
- ждём подрядчика или портал → [Ожидание подрядчика]
